...
export class LoggerService {
    ...
    public log(message: string) {
        if (this.config.loggingEnabled && this.config.loggingLevel === LoggingLevelEnum.Debug) {
            this.logs.push({ message, level: LoggingLevelEnum.Log });
    ...
    public warn(message: string) {
        if (this.config.loggingEnabled && this.config.loggingLevel === LoggingLevelEnum.Debug) {
            this.logs.push({ message, level: LoggingLevelEnum.Warn });
    ...
    public error(message: string) {
        if (this.config.loggingEnabled) {
            this.logs.push({ message, level: LoggingLevelEnum.Error });
